class TodoItemsController < ApplicationController
  ...
  # HV: before_action :set_todo_item, only: [:show, :edit, :update, :destroy] #new and create not applied as item not exist yet to set_item 
  ...
  # GET /todo_items/new
  def new
    @todo_item = @todo_list.todo_items.new #(todo_item_params) #TodoItem.new  
  #HV: new method only open a form, do not need params yet
  end
  ...
  #HV: now create method must have params   
    @todo_list.save()
  ...
  def destroy  #redirect_to todo_lists_url
    @todo_item.destroy
    respond_to do |format|
